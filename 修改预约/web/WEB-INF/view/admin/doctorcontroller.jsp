...
<div id="box">此处显示  id "box"
  ...
  <div id="middle">
    ...
    <div id="edit"
         style="position: absolute; stop: 343px; left: 122px; background: #F7ECF9; font-size: 14px; color: black; z-index: 900; border: 2px #FFCC00 solid; width: 366px; height: 450px; padding: 9px; top: 200px;">
      <div style="width: 350px; text-align: right;">
        <div
                style="background-position: right top; background-repeat: no-repeat; background-image: url('/image/close.png'); font-weight: bold; cursor: hand; font-size: 18px; color: #D6D6D6;"
    ...
    <div id="add"
         style="position: absolute; stop: 343px; left: 122px; background: #F7ECF9; font-size: 14px; color: black; z-index: 900; border: 2px #FFCC00 solid; width: 366px; height: 400px; padding: 9px; top: 200px;">
      <div style="width: 350px; text-align: right;">
        <div
                style="background-position: right top; background-repeat: no-repeat; background-image: url('/image/close.png'); font-weight: bold; cursor: hand; font-size: 18px; color: #D6D6D6;"
