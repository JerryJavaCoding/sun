...
<div id="box">
  ...
  <div id="up">
    ...
    <tr>
     ...
     <c:forEach var="user" items="${requestScope.users}">
      <td class="active" width="60" valign="bottom" height="36"><a href="/user/gotomain/${user.Id}">首页</a></td>
       </c:forEach>
  ...
  <div id="middle">
    ...
    <table width="52%" border="0" cellpadding="2" cellspacing="1">
     <c:forEach var="user" items="${requestScope.users}">
      <tr align="center">
        <td><a href="/user/domyyu/${user.Id}" class="btn btn-success btn-block btn-sm" >预约待办</a></td>
        <td><a href="/user/domyyuyi/${user.Id}" class="btn btn-success btn-block btn-sm" >预约已办</a></td>
      </tr>
       </c:forEach>
    </table>
    <p>&nbsp;</p>
