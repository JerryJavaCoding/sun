  ...
  <div id="middle">
    ...
    <table width="62%" border="0" cellpadding="2" cellspacing="1">
      ...
      <c:forEach var="doctor" items="${requestScope.doctors}">
        <td><a href="/doctor/dorderdai/${doctor.dId}" class="btn btn-success btn-block btn-sm" >预约待办</a></td>
        <td><a href="/doctor/dorderyi/${doctor.dId}" class="btn btn-success btn-block btn-sm" >预约已办</a></td>
