...
<div id="box">
  ...
  <div id="content">
    ...
    <div id="right" style="position: absolute;left: 500px;width: 366px; height: 400px; padding: 9px; top: 500px;">
    <div class="table_box">
      <table class="list">
        <tbody>
        ...
        <c:forEach var="article" items="${requestScope.articles}">
          <tr class="active">
            ...
            <td width="280" style="text-align:left;">${article.title}</td>
            <td height="20" align="right" valign="bottom">
              <a class="more" href="/user/doarselect/${article.aId}" >查看文章</a></td>
            </tr>
          </tr>
        </c:forEach>
        </#list>
