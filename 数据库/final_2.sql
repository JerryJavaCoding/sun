...
CREATE TABLE `pet` (
  ...
  `Id` int(4) NOT NULL DEFAULT '0' COMMENT '主人编号',
  `age` int(11) NOT NULL DEFAULT '0' COMMENT '年龄',
  `identity` varchar(59) NOT NULL DEFAULT '' COMMENT '类别',
  PRIMARY KEY (`PId`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=gbk COMMENT='宠物信息表';

#
# Data for table "pet"
#

INSERT INTO `pet` VALUES (1,'小小',1,2,'猫'),(2,'妮妮',1,3,'狗'),(3,'lili',2,1,'猫'),(4,'大大',2,4,'狗');
