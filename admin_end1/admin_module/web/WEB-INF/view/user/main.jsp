...
<div id="box">
  ...
  <div id="content">
    ...
    <div id="right" >
      ...
      <div class="table_box" style="position: absolute; left: 440px; width: 366px; height: 407px; padding: 9px; top: 730px;">
          ...
          <c:forEach var="article" items="${requestScope.articles}">
            <tr class="active">
              ...
              <td height="33" align="right" valign="bottom">
                <a style="activ:none" class="more" href="/user/doarselect/${article.aId}">查看文章</a></td>
            </tr>
          </c:forEach>
          </#list>
          <td height="2"></tbody>
